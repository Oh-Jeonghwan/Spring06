	...
	<div class="outer">
		<form action="join.do" method="post">
			<div class="form-group">
				...
				별명 <br>
				<input type="text" name="memberNick" id="nick" required style="width:300px"
					onchange="nickCheck()"><br>
				...
				<div class="address">
					...
					<input type="text" name="baseAddr" id="sample6_address" style="width:300px"  placeholder="주소">&nbsp;&nbsp;
					
					<input type="text" name="extraAddr" id="sample6_detailAddress" placeholder="상세주소">
					<br><br> 
				</div>
				
				<!-- 생년월일 정규화 -->
				생년월일<br>
				<input type="text" name="birth" id="bdDay" required style="width:300px"
				...
				자기소개 : <br>
				<textarea name="memberIntro" style="resize:none;" cols="70" rows="10" 
				placeholder="(한글 최대 1333글자까지)"></textarea><br><br>
	...
	<script type="text/javascript">
		...
		function nickCheck(){
			$.ajax({
				...
				success:function(result){
					if(result>0){
						$("#nickCheck").text("중복된 NickName입니다.");
						$("#nickCheck").css('color','red');
						$("#nickCheck").css('font-size','5px');
					}
					else{
						$("#nickCheck").text("사용 가능한 NickName입니다.");
