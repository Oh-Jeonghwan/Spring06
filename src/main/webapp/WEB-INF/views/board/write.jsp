		...
		<div class="bAdd" align="center">
			<form action="${pageContext.request.contextPath}/board/write.do" method="post">
				<div align="left">
					...
					제목: <input type="text" name="boardTitle" style="width:600px; height:35px"> <br><br>
					<textarea name="boardContent" id="boardContent" style="resize:none; width:830px; height:500px;"></textarea>
				</div>
				<br><br>
